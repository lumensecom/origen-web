...
async function verifyAdmin(authHeader) {
  ...
  // Confirm the caller has rol='admin' in empleados
...
export default async function handler(req, res) {
  // CORS headers for local vercel dev
  ...
  // Body: { email, password, full_name, rol, id_local? }
  // -------------------------------------------------------------------------
  if (req.method === 'POST') {
    ...
    // For staff: insert into empleados (handle_new_user trigger already seeded clientes)
