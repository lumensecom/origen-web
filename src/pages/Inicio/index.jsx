...
const HomeView = ({ navigate, onOpenSavia }) => {
  ...
  return (
    <div ref={containerRef} className="w-full relative bg-[var(--fondo-crema)] pb-32">
      ...
      {/* Stats */}
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.4 }} variants={staggerContainer} className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 py-10 relative z-20">
        {[
