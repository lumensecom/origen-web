          ...
          >
            ...
            <div className="bg-[var(--verde-profundo)] px-7 pt-5 pb-6 relative shrink-0">
              ...
              <div className="flex items-center gap-3 mb-1">
                <img src={SIVO_MASCOT} alt="Mr. Sivio" className="w-10 h-10 object-contain drop-shadow-lg" />
                <div>
                  <h2 className="font-display italic text-2xl text-white leading-none">Mr. Sivio</h2>
            ...
            <div className="flex-1 overflow-y-auto px-7 py-7">
              <AnimatePresence mode="wait">
                {!isResult ? (
                  ...
                  >
                    <img src={SIVO_MASCOT} alt="Mr. Sivio" className="w-16 h-16 object-contain mb-2 drop-shadow-md" />
                    <p className="font-ui text-[11px] font-bold uppercase tracking-wider text-[var(--verde-main)] mb-3">Mr. Sivio recomienda para ti</p>
